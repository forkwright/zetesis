...
| `search_missing_title.json` | synthetic | one paper without `title` |
...
| `duplicate_candidates.json` | synthetic | the Semantic Scholar side of the router's duplicate cases |
...
| `search_missing_title.xml` | synthetic | one entry without `<title>` |
...
| `duplicate_candidates.xml` | synthetic | the arXiv side of the router's duplicate cases |
...
| `search_missing_key.json` | synthetic | one page without `key` |
