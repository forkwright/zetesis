...
- [Static acquisition producer release](docs/design/static-acquisition-release.md) - the merged revision consumers pin, evidence schema and extractor versions, conformance fixtures with their digests, the compatibility evidence a consumer records, and upgrade and rollback.
